...
class SongFactoryTest {
    ...
    void testCreate() {
        ...
        var expected = Song.builder()
                ...
                .instrumentalness(0)
                .goodForParty(false)
                .goodForWorkStudy(false)
                .goodForRelaxationMeditation(false)
                .goodForExercise(false)
                .goodForRunning(false)
                .goodForYogaStretching(false)
                .goodForDriving(false)
                .goodForSocialGatherings(false)
                .goodForMorningRoutine(false)
